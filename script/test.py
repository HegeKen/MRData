...
check_url = "http://update.miui.com/updates/miotaV3.php"

def decipher(en_resp):
  aes = AES.new(miui_key,AES.MODE_CBC,miui_iv)
  resp = aes.decrypt(base64.b64decode(urllib.parse.unquote(en_resp))).decode("utf-8")
  print(resp)
