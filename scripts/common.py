...
currentBeta = ["cupid","zeus","daumier","mayfly","unicorn","thor","fuxi","nuwa","ishtar","zizhan","babylon","dagu","rubens","matisse","ingres","diting","mondrian","socrates"]
...
newDevices = ["houji","shennong","duchamp","sapphiren","sapphire","aurora","manet","vermeer","aristotle","garnet","zircon","gold"]
